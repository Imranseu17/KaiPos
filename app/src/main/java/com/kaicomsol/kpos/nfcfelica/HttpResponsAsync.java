...
public class HttpResponsAsync  {
    ...
    public static class addAccountBalanceArgument {
    ...
    public static class addTransactionArgument {
        public String accountNumber;
        public ArrayList<addTransactionArgumentItemInfo> items = new ArrayList();
        public String posKey;
    }

    public static class addTransactionArgumentItemInfo {
    ...
    public class getChargeAmountsResult {
        public ArrayList<getChargeAmountsInformation> getChargeAmountsInformations = new ArrayList();
    }
    ...
    public class getDetailedCustomerInformationResult {
        ...
        public ArrayList<getDetailedCustomerInformationResultTransactionHistory> transactionHistorys = new ArrayList();
    }
    ...
    public static class getTariffInformationArgument {
        public String meterSerialNumber;
    }

    public class getTariffInformationResult {
        String meterSerialNumber;
        public String tariffBasePrice;
        ...
        try {
            ...
            if (!this.Success) {
                ...
                if (z) {
                    ...
                    this.ErrorString = Common.getResources().getString(R.string.pos_key_invalid);
                }
            }
            return this.Success;
        } catch (JSONException e) {
