...
import com.kaicomsol.tpos.adapter.CustomerAdapter;
import com.kaicomsol.tpos.callbacks.CustomerClickListener;
import com.kaicomsol.tpos.callbacks.CustomerView;
import com.kaicomsol.tpos.dialogs.CustomAlertDialog;
import com.kaicomsol.tpos.models.Customer;
import com.kaicomsol.tpos.models.CustomerData;
import com.kaicomsol.tpos.models.Like;
import com.kaicomsol.tpos.presenters.CustomerPresenter;
...
public class AccountListActivity extends AppCompatActivity implements CustomerView, CustomerClickListener {
    ...
    public void onLogout(int code) {
        SharedDataSaveLoad.remove(com.kaicomsol.tpos.activity.AccountListActivity.this, getString(R.string.preference_access_token));
        SharedDataSaveLoad.remove(com.kaicomsol.tpos.activity.AccountListActivity.this, getString(R.string.preference_is_service_check));
        Intent intent = new Intent(com.kaicomsol.tpos.activity.AccountListActivity.this, com.kaicomsol.tpos.activity.LoginActivity.class);
    ...
    public void onCustomerClick(Customer customer) {
        ...
        Intent intent = new Intent(com.kaicomsol.tpos.activity.AccountListActivity.this, CustomerDetailsActivity.class);
        startActivity(intent);
    }
