...
import com.kaicomsol.tpos.callbacks.RefundView;
...
import com.kaicomsol.tpos.models.Refund;
import com.kaicomsol.tpos.models.UpdateResponse;
import com.kaicomsol.tpos.presenters.RefundPresenter;
import com.kaicomsol.tpos.utils.CardPropertise;
...
public class RefundActivity extends AppCompatActivity implements RefundView, CloseClickListener {
    ...
    private void viewConfig() {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else CustomAlertDialog.showError(com.kaicomsol.tpos.activity.RefundActivity.this, "Issue refund failed Please try again!");
            }
        });
    ...
    public void onSuccess(UpdateResponse updateResponse) {
        ...
        if (response && credit == 0.0){
           ...
           mAccessFalica.WriteStatus(tag, Integer.parseInt(historyNo)+1);
        }
        if (response){
            rechargeCardDismiss();
            updatedData();
    ...
    public void onLogout(int code) {
        SharedDataSaveLoad.remove(com.kaicomsol.tpos.activity.RefundActivity.this, getString(R.string.preference_access_token));
        SharedDataSaveLoad.remove(com.kaicomsol.tpos.activity.RefundActivity.this, getString(R.string.preference_is_service_check));
        Intent intent = new Intent(com.kaicomsol.tpos.activity.RefundActivity.this, com.kaicomsol.tpos.activity.LoginActivity.class);
    ...
    private void updateRefund() {
        ...
        if (checkConnection()) {
            String token = SharedDataSaveLoad.load(com.kaicomsol.tpos.activity.RefundActivity.this, getString(R.string.preference_access_token));
        ...
        new ChooseAlertDialog(this)
                ...
                .setNegativeListener(getString(R.string.yes), new ChooseAlertDialog.OnNegativeListener() {
                    ...
                    public void onClick(ChooseAlertDialog dialog) {
                        dialog.dismiss();
                        mAdapter.enableForegroundDispatch(com.kaicomsol.tpos.activity.RefundActivity.this, pendingIntent, intentFiltersArray, techListsArray);
                        rechargeCardDialog();
    ...
    class ReadAsyncTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean response) {
            ...
            if (response) {
                if (mAccessFalica.cardGroup.equals(CardPropertise.CUSTOMER_CARD.getCode())
                    ...
                    if (!isCardRefund) {
                        ...
                        if (checkConnection()) {
                            ...
                            CustomAlertDialog.showError(com.kaicomsol.tpos.activity.RefundActivity.this, getString(R.string.no_internet_connection));
                    } else {
                        rechargeCardDismiss();
                        updateRefund();
                ...
                } else CustomAlertDialog.showError(com.kaicomsol.tpos.activity.RefundActivity.this, getString(R.string.not_available_refund));
            } else CustomAlertDialog.showWarning(com.kaicomsol.tpos.activity.RefundActivity.this, getString(R.string.err_card_read_failed));
